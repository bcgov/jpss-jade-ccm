...
public class CcmPidpAdapterTest extends CamelQuarkusTestSupport {

	@Inject
	CamelContext context;

	
	@Produce("direct:publishBodyAsEventKPI")
	...
	protected RoutesBuilder createRouteBuilder() {
		return new CcmPidpAdapter(); 
		
	}

	@Test
	public void testpublishBodyAsEventKPI() throws Exception {
		
		/**
		 * @author mcostell
		 * weave into the camelcontext and replace this endpoint id with our mock kafka endpoint 
		 */
		AdviceWith.adviceWith(context, "publishBodyAsEventKPI", a -> {
		...
		.to("direct:publishBodyAsEventKPI").send();
		/**
		 * @author mcostell
