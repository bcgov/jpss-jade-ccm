...
| Charge Assessment Case | INFERRED_AUTH_LIST_CHANGED |[Diagram](../diagrams/img/ccm_charge_assessment_case_auth_list_changed_processing_sequence_diagram.png) ([source](../diagrams/ccm_charge_assessment_case_auth_list_changed_processing_sequence_diagram.plantuml))|
