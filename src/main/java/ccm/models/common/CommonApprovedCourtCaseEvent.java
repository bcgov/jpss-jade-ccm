...
public class CommonApprovedCourtCaseEvent extends CommonBaseEvent {
  ...
  public CommonApprovedCourtCaseEvent() {
    super();
    super.setEvent_version(EVENT_VERSION);
  }

  public CommonApprovedCourtCaseEvent(JustinEvent je) {
    this();
  ...
  public CommonApprovedCourtCaseEvent(String event_source, CommonApprovedCourtCaseEvent another) {
    super(another);
  ...
  public CommonApprovedCourtCaseEvent copy(String event_source) {
    return new CommonApprovedCourtCaseEvent(event_source, this);
  }
