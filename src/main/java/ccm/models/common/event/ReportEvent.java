...
public class ReportEvent extends BaseEvent{
    ...
    public enum REPORT_TYPES {
      ...
      ACCUSED_INFO("AI", "ACCUSED INFORMATION"),
      POLICE_WILL_SAY("POLICEWILLSAY", "POLICE WILL SAYS"),
      WITNESS_WILL_SAY("WITNESSWILLSAY", "WITNESS WILL SAYS"),
      ...
      FILE_SUMMARY_REPORT("FSR", "FILE SUMMARY REPORT"),
      ...
      SENTENCE_DOCUMENT("SO", "CONDITIONAL SENTENCE ORDER");
