...
public class ReportEvent extends BaseEvent{
    ...
    public enum REPORT_TYPES {
      ...
      VEHICLE("VEH"),
      DV_IPV_RISK("IPVRISK"),
      DV_ATTACHMENT("DVRISK"),
      DM_ATTACHMENT("MR"),
      SUPPLEMENTAL("SUPPLEMENTAL"),
      SYNOPSIS("SYN"),

      RECORD_OF_PROCEEDINGS("ROP"),
      CONVICTION_LIST("CL"),

      CLIENT_HISTORY_REPORT_DISPOSITION("CORNET-DISPO"),
      CLIENT_HISTORY_REPORT_FULL("CORNET-FULL"),
      FILE_SUMMARY_REPORT("FSR"),
      ACCUSED_HISTORY_REPORT("AHR"),
      RELEASE_ORDER("RO"),

      INFORMATION("INFO"),
      DOCUMENT("DOCUMENT"),
      RELEASE_DOCUMENT("RO"),
      SENTENCE_DOCUMENT("SENTENCE_DOCUMENT");
/*
NARRATIVE
WITNESS_STATEMENT
CPIC_DOC
