...
public class JustinDocumentKey {
  ...
  public String getCourt_agen_id() {
    return court_agen_id;
  }

  public void setCourt_agen_id(String court_agen_id) {
    this.court_agen_id = court_agen_id;
  }

  public String getSequence_numbers() {
    return sequence_numbers;
  }

  public void setSequence_numbers(String sequence_numbers) {
    this.sequence_numbers = sequence_numbers;
  }
