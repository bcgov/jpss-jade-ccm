...
// camel-k: trait=jvm.classpath=/etc/camel/resources/models.jar
...
class JustinEventListProcessor implements Processor {
  ...
  public void process(Exchange exchange) throws Exception {
    ...
    System.out.println("Body.id: " + td.getId());
    System.out.println("Body.phone: " + td.getPhone());
    ...
    if (contacts == null) {
      ...
      Iterator<TestContactDetails> c = td.getContacts().iterator();
      System.out.println("Contact details:");
      while(c.hasNext()) {
        System.out.println(c.next().toString() + (c.hasNext() ? "," : ""));
      }
    }
...
public class TestDataProcessor extends RouteBuilder {
  @Override
