...
public class DemsListItemFieldData {
    ...
    public enum CASE_FLAG_FIELD_MAPPINGS {
        ...
        VUL1("VUL1"), CHI1("CHI1"), K("K"), Indigenous("Indigenous"), HROIP("HROIP"), DO_LTO("DO/LTO");
    ...
    public enum CASE_DECISION_FIELD_MAPPINGS {
        ...
        ADV("ADV - Alternative Measures"), ACT("ACT - Approved to Court"), RET("RET - Return to Enforcement Agency"),
        ACL("ACL - Caution Letter"), NAC("NAC - No Action/Charge"), REF("REF - Referred");
    ...
    public enum CASE_GROUP_FIELD_MAPPINGS {
        SYSTEM_SUPPORT("JRS_SYSTEM_SUPPORT", "System Support"), ADMINISTRATOR("JRS_ADMINISTRATOR", "Administrator"),
        LAWYER("JRS_BASE_LAWYER", "Lawyer"), LEGAL_ASSISTANT("JRS_BASE_LEGAL_ASST", "Legal Assistant"),
