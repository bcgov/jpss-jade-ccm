...
import ccm.dems.useraccess.adapter.models.event.versioning.Version;
import ccm.dems.useraccess.adapter.utils.DateTimeUtils;

public class EventKPI {
    public enum STATUS {
        EVENT_UNKNOWN, EVENT_CREATING, EVENT_CREATION_FAILED, EVENT_CREATED, EVENT_PROCESSING_STARTED,
        EVENT_PROCESSING_COMPLETED, EVENT_PROCESSING_FAILED, EVENT_PROCESSING_WARNING;
    }
