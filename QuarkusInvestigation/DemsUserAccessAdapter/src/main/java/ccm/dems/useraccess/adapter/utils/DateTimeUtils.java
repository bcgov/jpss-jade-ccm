package ccm.dems.useraccess.adapter.utils;
...
public class DateTimeUtils {
    ...
    public static String convertToUtcFromBCDateTimeString(String bcDateTimeString) throws DateTimeParseException {
        ...
        if (zonedDateTime != null) {
            utcDateTimeString = zonedDateTime.withZoneSameInstant(ZoneId.of("UTC"))
    ...
    public static ZonedDateTime convertToZonedDateTimeFromBCDateTimeString(String bcDateTimeString)
