package ccm.dems.useraccess.adapter.models.event;

import java.util.Iterator;

import ccm.dems.useraccess.adapter.models.system.justin.JustinEvent;
import ccm.dems.useraccess.adapter.models.system.justin.JustinEventDataElement;
import ccm.dems.useraccess.adapter.models.system.pidp.PidpUserModificationEvent;
...
public class CaseUserEvent extends BaseEvent {
    ...
    public enum STATUS {
        ACCOUNT_CREATED, ACCESS_ADDED, ACCESS_REMOVED;
    }
