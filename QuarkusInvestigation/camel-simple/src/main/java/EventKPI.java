...
public class EventKPI {
    ...
    public EventKPI(Object event, STATUS status) {
       // this(event);
        setKpi_status(status.name());
    }

    public EventKPI(Object event, String suggested_status_string) {
